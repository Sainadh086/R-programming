...
#df <- read.csv('/home/varshan/Documents/Online Learning/R language/data/rprog_data_ProgAssignment3-data/hospital-data.csv')

outcome <- data.table::fread('/home/varshan/Documents/Online Learning/R language/data/rprog_data_ProgAssignment3-data/outcome-of-care-measures.csv')
out_dt <- outcome
df1 <- outcome
...
best <- function(state, outcome) {
  ...
  # Read outcome data
  out_dt<- df1 #<- data.table::fread('outcome-of-care-measures.csv')
